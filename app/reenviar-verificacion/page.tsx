...
function ReenviarVerificacionForm() {
        ...
        {enviado ? (
          <div style={{ textAlign: 'center' }}>
            <p style={{ fontSize: '15px', color: 'var(--color-ink)', marginBottom: '18px' }}>
              ✅ Si ese correo está registrado y todavía no está verificado, te acabamos de reenviar el enlace de verificación. Revisa tu bandeja de entrada (y la de spam, por si acaso).
            </p>
            <a href="/login" style={{
          ...
          <form onSubmit={handleSubmit}>
            <p style={{ fontSize: '13px', color: 'var(--color-line)', marginBottom: '18px' }}>
              Escribe el correo con el que te registraste — si todavía no lo has verificado, te reenviamos el enlace.
            </p>
